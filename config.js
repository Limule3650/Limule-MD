...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'limule-md',
    ...
    BOT_INFO: process.env.BOT_INFO || 'limule-md;god limule solitarus;237693538738;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'limule-md;god limule solitarus;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'limule-md;god limule solitarus' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '237693538738,0',
       DEBUG: DEBUG
};
