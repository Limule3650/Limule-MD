...
1. Deploy on Heroku
   ...
   - [FORK](https://github.com/Limule3650/Death-limule-MD-/fork) this repository.
...
2. Deploy on Koyeb
   ...
   - Get [DATABASE_URL](https://github.com/Limule3650/Death-limule-MD-/wiki/DATABASE_URL). You'll need this while deploying.
   ...
   - Enter [Environment Variables](https://github.com/Limule3650/Death-limule-MD-/wiki/Environment_Variables). [Read More](https://github.com/Limule3650/Death-limule-MD-/wiki/Environment_Variables).
...
3. Deploy on VPS or PC (Example here as in Ubuntu)
   ...
   - Install with script
         ...
         wget -N -O Deathlimule.sh http://bit.ly/43JqREw && chmod +x Deathlimule.sh && ./Deathlimule.sh
   ...
   - Install without a script
       ...
       - Clone the repository and install packages:
             ...
             git clone https://github.com/Limule3650/Death-limule-MD- botName
              cd botName
    ...
    - [Read More](https://github.com/Limule3650/Death-limule-MD-/wiki/Environment_Variables)
...
- [mr death](https://github.com/royalmrdeath) for contribution 
